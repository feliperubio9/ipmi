...
noTint();
  ...
  if (fadeG >= 255){
funcionTexto(20, 13,336, 627, 460, "En 1984, tras una serie de conflictos globales a principios del siglo XX, el mundo está dividido en tres superpotencias: Oceanía, Eurasia y Asia Oriental, quienes se encuentran en un estado de guerra permanente.");
if(textofin == true){
...
noTint();
funcionTexto(20, 13,302, 627, 460, "A medida que sus pensamientos críticos aumentan, Winston comienza a realizar pequeños actos de rebeldía que representan un grave delito en Oceanía. En una sociedad donde incluso las ideas son vigiladas, cuestionar al Partido o conservar una opinión propia puede considerarse una amenaza para el sistema.");
  if(textofin == true){
habilitarbotonpausa = true;
  }
if(timer >= 6010){
...
funcionTexto(20, 13,285, 627, 460, "En su búsqueda por comprender la verdad y recuperar cierta libertad individual, Winston conoce a Julia, una joven miembro del Partido con quien inicia una relación secreta. Juntos comparten un profundo rechazo hacia el control impuesto por el sistema y encuentran en su vínculo una forma de resistencia frente a la opresión de Oceanía.");
  if(textofin == true){
habilitarbotonpausa = true;
  }
  if (timer >= 7100){
...
noTint();
funcionTexto(20, 13,325, 627, 460, "Sin embargo, en Oceanía nada escapa al control del Partido. Lo que Winston y Julia creen ser un espacio seguro termina convirtiéndose en una trampa, demostrando que el sistema de vigilancia y manipulación es mucho más amplio y poderoso de lo que imaginaban.");
if(textofin == true){
habilitarbotonpausa = true;
  }
  if (timer >= 7850){
